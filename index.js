...
const taskRouter = require("./routes_FD/task.routes"); // Import the router
const userRouter = require("./routes_FD/user.routes"); // Import the router

const PORT = process.env.PORT || 4000;  // Fixing the PORT by using OR `||` instead of bitwise `|`

// Database connection details
const { MONGO_IP, MONGO_PORT, MONGO_USERNAME, MONGO_PASSWORD } = require("./configure_FD/config");
...
app.use("/api/user", userRouter); // Routes for user will now be prefixed with /api/user
